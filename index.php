...
<html>
    ...
    <head>
        ...
        <title>Systeme inventaire</title>
...
?>
		...
		<div id="formContainer">
			...
			<form id="login" method="post" action="login.php">
				...
				<input type="text" name="username" required="required" id="loginEmail" placeholder="Username" />

				<input type="password" name="password" required="required"  id="loginPass" placeholder="Password" />
